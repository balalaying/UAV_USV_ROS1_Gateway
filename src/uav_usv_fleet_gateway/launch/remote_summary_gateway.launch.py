...
def generate_launch_description():
    ...
    base_station_state_topic = LaunchConfiguration('base_station_state_topic')
    base_station_events_topic = LaunchConfiguration('base_station_events_topic')
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'base_station_state_topic', default_value='/base_station/state'),
        DeclareLaunchArgument(
            'base_station_events_topic', default_value='/base_station/events'),
        DeclareLaunchArgument(
        ...
        Node(
            ...
            parameters=[config, {
                ...
                'enable_base_station_service': enable_base_station_service,
                'base_station_state_topic': base_station_state_topic,
                'base_station_events_topic': base_station_events_topic,
                'enable_world_model_publish': False,
                'world_model_publish_rate_hz': 0.1,
