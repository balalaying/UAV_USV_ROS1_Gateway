...
GZ_INSTALL_ROOT="${GZ_INSTALL_ROOT:-/home/liu/gz_harmonic_ws/install}"
...
export GZ_GUI_PLUGIN_PATH="/home/liu/gz_harmonic_ws/install/gz-sim8/lib/gz-sim-8/plugins/gui:/home/liu/gz_harmonic_ws/install/gz-gui8/lib/gz-gui-8/plugins:${GZ_GUI_PLUGIN_PATH:-}"
